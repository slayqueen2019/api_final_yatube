...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(('user', models.F('following')), _negated=True), name='no_self_follow'), models.UniqueConstraint(fields=('user', 'following'), name='unique_following')],
            },
        ),
    ]
